"""Einheitliches Erscheinungsbild - geteilt von allen *desk-Apps.

Bewusst zurueckhaltend: Farben und Schrift kommen weiterhin vom System, damit
sich die App in helle wie dunkle Themes einfuegt. Ergaenzt werden nur
Abstaende, Rundungen und eine Akzentfarbe - alles aus der Palette
abgeleitet, nichts fest verdrahtet. Enthaelt keine App-spezifischen Regeln;
falls eine App mal eigene braucht, haengt sie sie hinter `build_stylesheet()`
an ihr eigenes Stylesheet an.
"""
